...
/*
 * class 를 만들고 @Contorller 라는 Annotation 을 부착하면
 * Spring Framework 에서 자동으로 
 * 이 클래스를 Controller 기능을 부여한다
 * 
...
public class UserController {
	...
	// form tag 의 method 속성을 반드시 POST 로 지정해야 한다
	// 데이터를 서버로 보낼때 요청하는 Request
	
	// client(web)에서 보낸 username 변수, password 변수에
	// 담긴 데이터를 받을때는 method 의 매개변수를 설정해 주면 된다
	...
	//@ 나는 변수명 다 일일히 넣었는데 안넣고 만들기
	//@ UserDto 를 만들어서 변수명 일일히 입력ㄴㄴ
//	public String join(String username, String password, String re_password,
//					   String name, String tel, String addr, Model model) {
		public String join(@ModelAttribute UserDto user, Model model) {	
		
		// Web Project 에서 Console 에 출력하여 확인하고자 할때
		// 절때 아래 코드 사용금지!!

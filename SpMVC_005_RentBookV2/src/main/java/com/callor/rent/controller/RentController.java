 ...
 * 때문에 Session 은 꼭 필요한 요소에서만 제한적으로 사용하는 것이 좋다
 * Session 을 남발하면, 메모리 누수(leak) 과 보안에 치명적인 문제를 
 * 		야기 할 수 있다
 * 
 */
...
public class RentController {
	...
	public String work_complete(
		...
		/*
		 * SessionAttributes 에 보관중인 객체(데이터)를 모두 사용한 후 에는
	...
	public RentBookVO newRentBook() {
		...
		// Java 는 1.8 을 기준으로 이전과 이후를 다른 세대로 구분한다
		// 1.7 이하는 1.x 로 표기 1.8 부터는 8,9,10 등으로 표기한다
		// Java 1.2 가 탄생했을때도 1.1과 1.2를 다른 세대로 구분하여 Java2 라고
		// 불렀었다
		// 적극 사용하기를 권장
